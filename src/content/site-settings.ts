...
export const siteSettings: SiteSettings = {
  ...
  instagramUrl: 'https://www.instagram.com/temantutor_id',
  tiktokUrl: undefined,
  youtubeUrl: undefined,
  areaServed: ['Jabodetabek', 'Bandung', 'Cimahi'],
  ...
  heroSubheadline:
    'Teman Tutor hadir sebagai teman belajar, teman bertumbuh untuk setiap anak. Tatap muka langsung ke rumah di area Jabodetabek, Bandung & Cimahi.',
  heroTrustBadges: [
    'Mulai Rp130rb/sesi',
    'Bisa Trial 1 Sesi',
